                                    ...
                                    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 6, marginBottom: 6 }}>
                                        {[["契約數量", "contractQty"], ["本日數量", "todayQty"], ["累計數量", "cumQty"]].map(([label, key]) => (
                                            <div key={key}>
                                                ...
                                                <input type="number" step="0.001" style={tisStyle} value={q[key]} onChange={e => { const v = parseFloat(e.target.value); updArr("quantities", i, key, isNaN(v) ? 0 : parseFloat(v.toFixed(3))); }} />
                                            </div>
                                        ))}
                                        <div>
