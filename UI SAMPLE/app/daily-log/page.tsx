...
export default function DailyLogPage() {
    ...
    // calculate how many "imported" days this month
                ...
                <header className="bg-white/80 backdrop-blur-lg sticky top-0 z-40 border-b border-slate-100"
                    ...
                    <div className="max-w-[1200px] mx-auto px-5 h-11 flex items-center justify-between gap-3">
                        <span className="text-[13px] text-slate-700 flex items-center gap-1.5">
                            <span className="material-icons-round text-[#1565C0] text-base">assignment</span>施工監造日誌
                        </span>
                    ...
                    <div className="max-w-[1200px] mx-auto px-5 py-5">
                        ...
                        `}
                                            ...
                                            >
                                                ...
                                                {/* Import status dot */}
                                                {!isFuture && (
                                                    <div className={`w-[5px] h-[5px] rounded-full mt-0.5 transition-colors ${hasData ? "bg-emerald-400" : "bg-slate-200"
                                                        }`} />
                                                )}
                                            </button>
                                        );
                                        ...
                                        {selectedData ? (
                                            <div className="p-5 space-y-4">
                                                ...
                                                <div className="flex gap-2 pt-3 border-t border-slate-50">
                                                    <button className="flex items-center gap-1 px-2.5 py-1.5 bg-slate-50 rounded-md text-[10px] text-slate-500 hover:bg-slate-100 transition-colors">
                                            ...
                                            <span className="text-xl text-slate-400">
                                                {(() => {
                                                    ...
                                                    for (let d = 1; d <= daysInMonth; d++) {
                                                        ...
                                                        if (dt <= today && !importedData[toKey(year, month, d)] && dt.getDay() !== 0 && dt.getDay() !== 6) count++;
                                                    }
                                                    return count;
                                                })()}
                                            </span>
                                        ...
                                        <div className="text-center">
                                            <span className="text-xl text-slate-300">
                                                {(() => {
                                                    let count = 0;
                                                    for (let d = 1; d <= daysInMonth; d++) {
                                                        if (new Date(year, month, d) > today) count++;
                                                    }
                                                    return count;
                                                })()}
                                            </span>
